...
/*
RecyclerView need an adapter which holds the recyclerView's data and binds it to the UI. Adapter will get the shopping list data using a parameter.
...
This will use ViewHolder inner class to get access to recyclerview_item layout views. Finally onBindViewHolder() function will be called to bind data to layout and UI.
